...
//-------------------------------------------------------------------
	...
	struct Mesh_Feature {//ground-truth feature
		Mesh tri;
...
//
		...
		friend ostream &operator<<(ostream &os, const arguments &arguments) {
			os << "choice: " << arguments.choice << std::endl
			   << "input: " << arguments.input << std::endl
			   << "output: " << arguments.output << std::endl
			   << "Hard_Feature: " << boolalpha << arguments.Hard_Feature << std::endl
			   << "octree: " << boolalpha << arguments.octree << std::endl
			   << "whole_domain: " << boolalpha << arguments.whole_domain << std::endl
			   << "pca_oobb: " << boolalpha << arguments.pca_oobb << std::endl
			   << "Hausdorff_ratio_t: " << arguments.Hausdorff_ratio_t << std::endl
			   << "edge_length_ratio: " << arguments.edge_length_ratio << std::endl
			   << "edge_length: " << arguments.edge_length << std::endl
			   << "Iteration_Base: " << arguments.Iteration_Base << std::endl
			   << "num_cell: " << arguments.num_cell << std::endl
			   << "scaffold_layer: " << arguments.scaffold_layer << std::endl
			   << "scaffold_type: " << arguments.scaffold_type << std::endl
			   << "weight_opt: " << arguments.weight_opt << std::endl
